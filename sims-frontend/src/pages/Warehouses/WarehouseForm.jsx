    ...
    <>
      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          <Input
            label='Code'
            placeholder='WH-MUM (auto-uppercase)'
            value={F.values.code}
            onChange={(e) => F.setFieldValue('code', e.target.value.toUpperCase())}
            onBlur={F.handleBlur}
            name='code'
            error={err('code')}
        ...
        <Select
          ...
          onChange={(e) => F.setFieldValue('manager_id', e.target.value)}
          error={err('manager_id')}
        >
