...
export default function Notifications() {
  ...
  return (
    <div
      style={{ maxWidth: 760, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 20 }}
    >
      {/* Page header */}
      <div
        style={{
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          {unreadCount > 0 && (
            <Button
              variant='ghost'
              size='sm'
              leftIcon={<DoneAllIcon style={{ fontSize: 16 }} />}
          ...
          <Button
            variant='ghost'
            size='sm'
            leftIcon={<ClearIcon style={{ fontSize: 16 }} />}
            onClick={handleClear}
          >
            Clear read
          </Button>
