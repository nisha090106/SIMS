...
function reducer(s, a) {
  switch (a.type) {
    ...
    case 'OK':
      return { loading: false, jobs: a.jobs };
    case 'ERR':
                          ...
                          >
                            ...
                            >
                              ...
                              <Pill
                                ...
                                color={job.failed_rows > 0 ? 'var(--color-danger)' : '#64748B'}
                              />
                              {job.started_at && (
                                <span
                                  style={{
                                ...
                                >
                                  Started: {fmtDT(job.started_at)} · Finished:{' '}
                                  {fmtDT(job.completed_at)}
                                </span>
                              )}
                            </div>
...
function Pill({ label, value, color }) {
  return (
    ...
    >
      {label}:<strong style={{ color, fontFamily: 'var(--font-mono)' }}>{value}</strong>
    </span>
  );
}
