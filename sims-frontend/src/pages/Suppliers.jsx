            ...
            {suppliers.length === 0 ? (
              ...
              suppliers.map((supplier, idx) => (
                <tr key={supplier.supplier_id}>
                  ...
                  <td>
                    <div className='stars-display'>{renderStars(supplier.rating || 0)}</div>
                  </td>
                  <td>
        ...
        <div className='detail-panel-overlay' onClick={handleCloseDetailPanel}>
          <div className='detail-panel' onClick={(e) => e.stopPropagation()}>
            <div className='detail-header'>
              ...
              <button className='close-btn' onClick={handleCloseDetailPanel}>
                ✕
              </button>
            </div>
            ...
            <div className='detail-body'>
              ...
              {/* Last Orders */}
              {detailData.last_5_purchase_orders &&
                detailData.last_5_purchase_orders.length > 0 && (
                  <div className='detail-section'>
