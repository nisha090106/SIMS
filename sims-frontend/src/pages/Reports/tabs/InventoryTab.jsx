    ...
    <>
      ...
      <div className='reports-kpi-grid'>
        <KpiCard
          ...
          color='blue'
          loading={loading}
          value={fmtNum(data?.summary?.totalSkus)}
        />
        <KpiCard
          ...
          color='green'
          loading={loading}
          value={fmtNum(data?.summary?.totalUnits)}
        />
        <KpiCard
          ...
          color='purple'
          loading={loading}
          value={fmtCurrency(data?.summary?.totalValue)}
        ...
        <KpiCard
          ...
          color='cyan'
          loading={loading}
          value={fmtCurrency(data?.summary?.totalCost)}
          sub='at cost price'
        />
        <KpiCard
