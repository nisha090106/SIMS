  ...
  return (
    <Box className='p-4 space-y-6'>
      ...
      <Box className='flex flex-wrap gap-4 items-center bg-white p-4 rounded-lg shadow'>
        ...
        <Button variant='outlined' onClick={handleExport} className='ml-auto'>
          Export CSV
        </Button>
      </Box>
            ...
            <Card>
              <CardContent>
                ...
                <Typography variant='h5'>
                  {data.items.length > 0
                    ? (
                        data.items.reduce((s, i) => s + i.fulfillmentRate, 0) / data.items.length
                      ).toFixed(1)
                    : 0}
                  %
                </Typography>
