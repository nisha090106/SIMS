              ...
              return (
                ...
                >
                  ...
                  <div className="card-meta-summary">
                    <span className={`status-badge-indicator ${req.status}`}>
                      {req.status}
                    </span>
                    ...
                    <div className="expanded-card-contents">
                      ...
                      {['approved', 'rejected', 'fulfilled'].includes(req.status) && (
                        <div className={`details-review-notes ${req.status}`}>
                          ...
                          <p>
                            {reviewerName ? `Reviewed by ${reviewerName}` : 'Reviewed by Logistics Team'}{' '}
                      ...
                      <div className="visual-timeline-box">
                        <div className="timeline-steps">
                          ...
                          {/* Step 2: Reviewed */}
                          <div className={`timeline-step ${['approved', 'rejected', 'fulfilled'].includes(req.status) ? 'active' : ''} ${req.status === 'rejected' ? 'rejected' : ''}`}>
                          ...
                          {/* Step 3: Fulfilled */}
                          <div className={`timeline-step ${req.status === 'fulfilled' ? 'active' : ''}`}>
