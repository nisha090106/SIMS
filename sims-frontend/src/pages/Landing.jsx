...
import { Menu, X, ChevronRight, TrendingUp, AlertCircle, Package, ShoppingCart, BarChart3, Lock } from 'lucide-react';
    ...
    <div className="landing-page">
      ...
      <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link to="/register" className="px-6 py-2 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 transition">
              Get Started
            </Link>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t animate-slideDown">
            <div className="container mx-auto px-4 py-4 flex flex-col gap-4">
              <button onClick={() => scrollToSection('features')} className="text-left py-2 hover:text-indigo-600 transition">
                Features
              </button>
              <button onClick={() => scrollToSection('how-it-works')} className="text-left py-2 hover:text-indigo-600 transition">
                How It Works
              </button>
              <button onClick={() => scrollToSection('pricing')} className="text-left py-2 hover:text-indigo-600 transition">
                Pricing
              </button>
              <button onClick={() => scrollToSection('footer')} className="text-left py-2 hover:text-indigo-600 transition">
                Contact
              </button>
              <div className="flex gap-2 pt-4 border-t">
                <Link to="/login" className="flex-1 px-4 py-2 text-center text-indigo-600 font-semibold border border-indigo-600 rounded-lg hover:bg-indigo-50 transition">
                  Login
                </Link>
                <Link to="/register" className="flex-1 px-4 py-2 text-center bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 transition">
                  Get Started
                </Link>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hero-content fadeInUp">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Real-time tracking, automated alerts, and powerful analytics — all in one platform. Transform how you manage inventory.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/register" className="px-8 py-3 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 transition inline-flex items-center justify-center gap-2">
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              See the impact SIMS has on businesses
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats_data.map((stat, index) => (
              <div key={index} className="stat-card fadeInUp" style={{ animationDelay: `${index * 0.1}s` }}>
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {steps.map((step, index) => (
              <div key={index} className="step-card fadeInUp" style={{ animationDelay: `${index * 0.15}s` }}>
      ...
      <section id="pricing" className="pricing-section">
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              { name: 'Starter', price: '$99', features: ['Up to 1,000 SKUs', 'Single Warehouse', 'Basic Reports'] },
              { name: 'Professional', price: '$299', features: ['Up to 50,000 SKUs', 'Multi-Warehouse', 'Advanced Reports', 'API Access'], highlight: true },
              { name: 'Enterprise', price: 'Custom', features: ['Unlimited SKUs', 'Unlimited Warehouses', 'Custom Integration', 'Dedicated Support'] },
            ].map((plan, index) => (
      ...
      <section id="cta" className="cta-section">
        <div className="container mx-auto px-4 py-20 text-center">
          ...
          <Link to="/register" className="inline-block px-10 py-4 bg-white text-indigo-600 rounded-lg font-bold text-lg hover:bg-indigo-50 transition">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li><button onClick={() => scrollToSection('features')} className="hover:text-indigo-600 transition">Features</button></li>
                <li><button onClick={() => scrollToSection('pricing')} className="hover:text-indigo-600 transition">Pricing</button></li>
