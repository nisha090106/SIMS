...
const validationSchema = Yup.object().shape({
  ...
  role: Yup.string()
    .oneOf(['staff', 'manager', 'admin'], 'Please select a valid role')
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    try {
      ...
      if (error.code === 'ERR_NETWORK') {
        errorMessage = 'Network error: Cannot reach the backend. Check if server is running on port 5000.';
        ...
        <div className="register-brand-side">
          ...
          <div className="brand-content">
            ...
            <p className="brand-tagline">
              Real-time synchronization, advanced logistics metrics, and intelligent supply-chain notifications in one cohesive console.
            </p>

            <div className="brand-features-list">
              <div className="brand-feature-item">
                <div className="bf-icon-box"><Warehouse size={18} /></div>
                <div>
              ...
              <div className="brand-feature-item">
                <div className="bf-icon-box"><TrendingUp size={18} /></div>
                <div>
              ...
              <div className="brand-feature-item">
                <div className="bf-icon-box"><ShieldCheck size={18} /></div>
                <div>
                  <h4>Role-Based Protection</h4>
                  <p>Rigorous security configurations customized for staff, managers, and admins.</p>
                </div>
              </div>
            </div>
                    ...
                    {isLoading ? (
                      <div className="button-loading-spinner-box">
                        <svg className="anim-spin-loader" viewBox="0 0 24 24">
                          <circle className="circle-bg" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" fill="none" />
