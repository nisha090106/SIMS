...
export default function PurchaseOrderForm() {
  ...
  /* ── Load reference data ── */
  useEffect(() => {
    Promise.all([supplierAPI.getAll({ limit: 500, status: 'active' }), warehouseAPI.getAll()])
      .then(([s, w]) => {
  ...
  useEffect(() => {
    ...
    debRef.current = setTimeout(() => {
      productAPI
        .getAll({ limit: 100, search: prodSearch || undefined })
    ...
    if (isEdit && existingPO) {
      ...
      return {
        ...
        expected_delivery: existingPO.expected_delivery
          ? existingPO.expected_delivery.split('T')[0]
          : '',
        ...
        return (
          ...
          >
            ...
            <Card
              ...
              subtitle='Fill in the details below. Save as draft or submit directly for approval.'
            >
              <Card.Body>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                  ...
                  <div>
                    ...
                    {!isAdmin && (
                      ...
                      >
                        Auto-assigned to your warehouse
                      </p>
                    )}
                  </div>
                  ...
                  {values.items.length === 0 ? (
                    ...
                    <div style={{ overflowX: 'auto' }}>
                      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <thead>
                          <tr>
                            {['#', 'Product', 'SKU', 'Qty', 'Unit Cost (₹)', 'Total', ''].map(
                              (h) => (
                  ...
                  {values.items.length > 0 && (
                    <div
                      style={{
                        ...
                        background:
                          'linear-gradient(180deg, var(--color-surface-alt), transparent)',
                      }}
                    >
                      <div
            ...
            {/* ── Action buttons ── */}
            <div
              style={{ display: 'flex', gap: 10, justifyContent: 'flex-end', paddingBottom: 24 }}
            >
