...
export default function ProductList() {
  ...
  const columns = [
    ...
    ...(isAdminOrManager ? [{ key: 'actions', label: '', width: 88, align: 'right' }] : []),
  ];
        ...
        <Table
          ...
          renderRow={(p, i) => (
            ...
            >
              ...
              {/* Status */}
              <td style={{ ...tdStyle, textAlign: 'center' }}>{statusBadge(p.is_active)}</td>
        ...
        <Modal.Body>
          <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
            ...
            <div>
              ...
              >
                This is a soft delete — the product will be hidden from active lists but its
                inventory and order history will be preserved.
              </p>
            </div>
          </div>
        </Modal.Body>
